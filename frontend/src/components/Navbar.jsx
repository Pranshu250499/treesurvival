  ...
  return (
    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-emerald-100 shadow-xs">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              title={
                isOffline
                  ? 'Rural Offline Sync Active (Logs buffered locally)'
                  : 'Online Cloud Connected'
              }
              className={`flex items-center space-x-1 px-2.5 py-1.5 rounded-xl text-xs font-semibold border transition cursor-pointer -translate-x-3 ${
                isOffline
        ...
        {/* =====================================================
            SECONDARY NAVIGATION — SMALL SCREENS
        ===================================================== */}
