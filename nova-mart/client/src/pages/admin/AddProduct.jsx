...
const AddProduct = () => {
  ...
  const [specs, setSpecs] = useState([
    { key: 'Material', value: 'Aerospace Grade Alloy' },
      ...
      <div className="flex items-center justify-between pb-6 border-b border-slate-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Create an inventory listing for your catalog</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2.5 text-xs border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 font-semibold text-slate-800"
              >
                {CATEGORIES.map((cat) => (
            ...
            <div className="sm:col-span-2">
              ...
              <textarea
                ...
                placeholder="Write an engaging overview of the features and benefits..."
                required
                className="w-full px-3.5 py-2.5 text-xs border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="34999"
                className="w-full px-3.5 py-2.5 text-xs border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 font-mono"
              />
            </div>
          ...
          <div className="space-y-3">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3.5 py-2 text-xs border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              />
              <button
                type="button"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 text-xs border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="S, M, L, XL or 256GB, 512GB"
                className="w-full px-3.5 py-2 text-xs border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20"
              />
            </div>
          </div>
            ...
            {specs.map((spec, idx) => (
              <div key={idx} className="flex gap-2 items-center">
                ...
                <input
                  ...
                  placeholder="Value (e.g. 30 Hours ANC)"
                  className="flex-1 px-3 py-2 text-xs border border-slate-200 rounded-xl"
                />
                <button
                  type="button"
